...
> 采集时间:**2026-08-30 19:17 ~ 19:26 +08**(Asia/Singapore)<br>
> 以下为采集时刻的静态快照,非实时数据。
...
这台机器存在**分流出口**:访问境外服务与访问境内服务经由两个不同的公网 IP。
...
| 查询来源 | `api.ipify.org`、`ifconfig.me`、`ipinfo.io`、`icanhazip.com`、`ident.me` — 五方结果一致 |

#### 境内线路出口(cip.cc)

| 项目 | 值 |
| --- | --- |
| 本机 IP | **39.106.200.193** |
| 地址 | 中国 北京 北京 |
| 运营商 | 阿里云 |
| 查询来源 | `cip.cc` |
| 详情页 | http://www.cip.cc/39.106.200.193 |
...
URL     : http://www.cip.cc/39.106.200.193
```
